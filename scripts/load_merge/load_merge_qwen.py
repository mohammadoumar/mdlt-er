...
LORA_DIR = Path.cwd().parent / "lfc_saved_lora" / "EC35_mm_Qwen2.5-VL-72B-Instruct-bnb-4bit"
OUTPUT_DIR = Path.cwd().parent / "lfc_merged_models"
MODEL_OUTPUT_DIR = OUTPUT_DIR / "qwen_2.5_72B_vision_merged"

# Model path for the fine-tuned Llama 3.2 Vision model

base_model_id = "Qwen/Qwen2.5-VL-72B-Instruct"   # SAME base used for LoRA
