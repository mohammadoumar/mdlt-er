...
LORA_DIR = Path.cwd().parent / "lfc_saved_lora" / "EC35_mm_Llama-3.2-90B-Vision-Instruct-bnb-4bit"
OUTPUT_DIR = Path.cwd().parent / "lfc_merged_models"
MODEL_OUTPUT_DIR = OUTPUT_DIR / "llama_3.2_90B_vision_merged"

# Model path for the fine-tuned Llama 3.2 Vision model

base_model_id = "unsloth/Llama-3.2-90B-Vision-Instruct"   # SAME base used for LoRA
