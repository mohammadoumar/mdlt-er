...
with open("/Utilisateurs/umushtaq/emorec_work/mdlt_er/datasets/json_datasets/emid_train.jsonl", "r", encoding="utf-8") as f:
    train_data = [json.loads(line) for line in f if line.strip()]

with open("/Utilisateurs/umushtaq/emorec_work/mdlt_er/datasets/json_datasets/emid_test.jsonl", "r", encoding="utf-8") as f:
